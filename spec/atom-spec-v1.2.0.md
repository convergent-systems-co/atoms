# The Atom Spec — v1.2.0

**Status:** v1.2.0 — Additive revision of v1.1.0. Adds Part XIV (AI Discovery Interface). All v1.1.0 atoms remain valid.

**Predecessor:** v1.0.0 (bootstrap, hand-authored). All v1.0.0 atoms remain verifiable; v1.1.0 is backward-compatible at the verification layer.
